...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 0.4, 1], [0, 200, 200]); // Stop at 200px with earlier trigger
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-80 relative z-10">
      <motion.h2
        style={{
